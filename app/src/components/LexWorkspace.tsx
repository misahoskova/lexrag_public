    ...
    <TooltipProvider>
      <div className="min-h-dvh bg-gradient-to-b from-background to-muted/30">
        ...
        <main className="mx-auto max-w-5xl p-4 space-y-6">
          ...
          <footer className="text-center text-[10px] text-muted-foreground/60 py-4 tracking-widest italic">
            LexRAG v3.2.0 &bull; Odpovědi jsou generovány AI a mohou obsahovat chyby.
          </footer>
        </main>
      </div>
    </TooltipProvider>
